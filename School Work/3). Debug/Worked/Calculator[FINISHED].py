...
menuOption = int(input("Enter a number from the menu above: "))#no idea why but if i change this to an Int the program runs i would guess its because the menu options are stored as int even tho its a str
